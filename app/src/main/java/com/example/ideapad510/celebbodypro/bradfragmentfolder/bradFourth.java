 ...
 * {@link bradFourth.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link bradFourth#newInstance} factory method to
 * create an instance of this fragment.
 */
public class bradFourth extends Fragment {
     ...
     * @return A new instance of fragment bradFourth.
     */
    // TODO: Rename and change types and number of parameters
    public static bradFourth newInstance(String param1, String param2) {
        bradFourth fragment = new bradFourth();
    ...
    private void preparewoirkoutdata() {
        ...
        Workout workout1=new Workout(getString(R.string.standingcurl),R.drawable.standingcurl1,R.drawable.seatedlegcurl2);
        workout1.setSets("3-5 ست ، 8-15 تکرار");
        workoutList.add(workout1);


        Workout workout2=new Workout(getString(R.string.hammercurl),R.drawable.hammer1,R.drawable.hammer2);
