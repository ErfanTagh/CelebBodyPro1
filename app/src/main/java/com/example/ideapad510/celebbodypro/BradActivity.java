...
public class BradActivity extends FragmentActivity {
        ...
        pager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                    ...
                    if (position==0){
                        ...
                        Log.e("pageSelected333: ", position + "");
                        t1.setText("روز چهارم");
                        t2.setText("بازو");
                    }

                     else if(position==4) {
                         Log.e("pageSelected444: ", position + "");
                        t1.setText("روز پنجم");
                        t2.setText("پا");
        ...
        public Fragment getItem(int pos) {
            switch (pos) {
                ...
                case 0:
                    ...
                    return bradFirst.newInstance("ThirdFragment", "Default");


                case 1:

                    Log.e( "getItem: ","In two" );
                    return bradSecond.newInstance("ThirdFragment", "Default");


                case 2:

                    Log.e( "getItem: ","In three" );
                    return bradThird.newInstance("ThirdFragment", "Default");


                case 3:

                    Log.e( "getItem: ","In four" );
                    return bradFourth.newInstance("ThirdFragment", "Default");

                case 4:
                    return bradFifth.newInstance("ThirdFragment", "Default");
